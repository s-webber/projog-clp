...
public class XorTest extends AbstractReificationTest {
   ...
   public XorTest() {
      ...
      given("1", "0:1").enforce(MATCHED, "1", "0").prevent(MATCHED, "1").reify(UNRESOLVED);
      given("0:1", "1").enforce(MATCHED, "0", "1").prevent(MATCHED, "1").reify(UNRESOLVED);
      given("0", "0:1").enforce(MATCHED, "0", "1").prevent(MATCHED, "0").reify(UNRESOLVED);
      given("0:1", "0").enforce(MATCHED, "1", "0").prevent(MATCHED, "0").reify(UNRESOLVED);
